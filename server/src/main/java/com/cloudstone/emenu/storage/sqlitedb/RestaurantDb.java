...
public class RestaurantDb extends SQLiteDb implements RestaurantDAO {
    ...
    public Restaurant update(EmenuContext context, Restaurant restaurant) {
        ...
        executeSQL(context, sql, new UpdateBinder(restaurant));
        return get(context, restaurant.getId());
    }
    ...
    private class UpdateBinder implements StatementBinder {
        ...
        public UpdateBinder(Restaurant restaurant) {
            super();
            this.restaurant = restaurant;
        }
        ...
        @Override
        public void onBind(SQLiteStatement stmt) throws SQLiteException {
            stmt.bind(1, restaurant.getName());
            stmt.bind(2, restaurant.getUpdateTime());
            stmt.bind(3, restaurant.isDeleted() ? 1 : 0);
            stmt.bind(4, restaurant.getId());
        }
    }
